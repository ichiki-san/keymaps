...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
     ...
     KC_ESC,KC_GRV,KC_LALT,KC_LGUI,KC_SPC,KC_MINS,LSFT(LCTL(KC_SPC)), LOWER, KC_EQL,  KC_ENT,  KC_BSPC, KC_BSLS, KC_DOWN, KC_UP \
     ),
  ...
  [_DVORAK] = LAYOUT( \
      ...
      KC_ESC,KC_GRV,KC_LALT,KC_LGUI,KC_SPC,KC_LBRC,LSFT(LCTL(KC_SPC)), LOWER, KC_RBRC, KC_ENT,  KC_BSPC, KC_BSLS, KC_DOWN, KC_UP \
      ),
  ...
  * |------+------+------+------+------+------|-------+-----+------+------+------+------+------+------|
  * | Esc  |ADJUST| Optn | Cmnd | Space|   ,  | LANG  |Lower|   .  | Enter| Bksp |   /  | Light| Right|
  * `-------------------------------------------------+-----+------+------+------+------+------+------'
   */
  [_LOWER] = LAYOUT( \
      ...
      KC_ESC,ADJUST,KC_LALT,KC_LGUI,KC_SPC,KC_COMM,LSFT(LCTL(KC_SPC)), LOWER, KC_DOT,  KC_ENT,  KC_BSPC,  KC_SLSH, KC_LEFT, KC_RGHT \
      ),
