...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * | LANG | Esc  | Alt  | GUI  | EISU |Lower |Space |Space |Raise | KANA | Left | Down |  Up  |Right |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = LAYOUT( \
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * | Shift|   Z  |   X  |   C  |   V  |   B  |             |   N  |   M  |   ,  |   .  |   /  |  ]   |
   * |------+------+------+------+------+------+-------------+------+------+------+------+------+------|
   * | Esc  |   -  |   `  | Optn | Cmnd | Space| LANG  |Lower| Enter| Bksp | Down |  Up  |   =  |  \   |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = LAYOUT( \
     ...
     KC_ESC,KC_MINS,KC_GRV,KC_LALT,KC_LGUI,KC_SPC,LSFT(LCTL(KC_SPC)), LOWER, KC_ENT,  KC_BSPC, KC_DOWN, KC_UP,   KC_EQL,  KC_BSLS  \
     ),
  ...
  [_DVORAK] = LAYOUT( \
     ...
     LSFT(LCTL(KC_SPC)),KC_ESC,KC_GRV,KC_LALT,KC_LGUI,KC_SPC,KC_MINS, KC_EQL,KC_ENT,  KC_BSPC, KC_BSLS, KC_DOWN, KC_UP,   LOWER \
      ),
  ...
  | Shift|   !  |   @  |   #  |   $  |   %  |             |   ^  |   &  |   *  |   (  |   )  |   =  |
  |------+------+------+------+------+------|-------+-----+------+------+------+------+------+------|
  | Esc  |   ,  |   `  | Optn | Cmnd | Space| LANG  |Lower| Enter| Bksp | Light| Right|   .  |   /  |
  `-------------------------------------------------+-----+------+------+------+------+------+------'
   */
  [_LOWER] = LAYOUT( \
      KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,                     KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12, \
      KC_LCTL, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                      KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, \
      KC_LSFT, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,                   KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_EQL, \
      KC_ESC,KC_COMM,ADJUST,KC_LALT,KC_LGUI,KC_SPC,LSFT(LCTL(KC_SPC)), LOWER, KC_ENT,  KC_BSPC, KC_LEFT, KC_RGHT, KC_DOT,  KC_SLSH  \
      ),


  /* Adjust (Lower + Raise)
   * ,-----------------------------------------.             ,-----------------------------------------.
   * | Reset| Reset|RGBRST|      |      |      |             |      |      |      |      |      |  Del |
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * |      |      |      |Aud on|Audoff| Mac  |             | Win  |      |      |      |      |      |
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * |      |      |      |      |      |      |             |      |      |RGB ON| HUE+ | SAT+ | VAL+ |
   * |------+------+------+------+------+------+-------------+------+------+------+------+------+------|
   * | Reset|      |      |      |      |      |Qwerty|Dvorak|      |      | MODE | HUE- | SAT- | VAL- |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_ADJUST] =  LAYOUT( \
      RESET,   RESET,   RGBRST,  _______, _______, _______,                   _______, _______, _______, _______, _______, KC_DEL, \
      _______, _______, _______, AU_ON,   AU_OFF,  AG_NORM,                   AG_SWAP, _______, _______, _______, _______, _______, \
      _______, _______, _______, _______, _______, _______,                   _______, _______, RGB_TOG, RGB_HUI, RGB_SAI, RGB_VAI, \
      RESET  , _______, _______, _______, _______, _______, QWERTY,  DVORAK,  _______, _______, RGB_MOD, RGB_HUD, RGB_SAD, RGB_VAD \
      )
};
  ...
  switch (keycode) {
    ...
    case LOWER:
      if (record->event.pressed) {
        ...
        layer_on(_LOWER);
        update_tri_layer_RGB(_LOWER, _DVORAK, _ADJUST);
      } else {
        #ifdef RGBLIGHT_ENABLE
...
#define L_ADJUST_TRI (L_ADJUST|L_LOWER)
